...
function UnsplashImage({ query }: { query: string }) {
  ...
  return (
    <div className="my-2">
      <p className="text-xs text-purple-400 font-bold mb-1">&#x1F3A8; Inspiration picture</p>
      <img src={url} alt={query} className="rounded-xl w-full max-h-56 object-cover shadow-md border-2 border-purple-100" />
    </div>
  );
}
